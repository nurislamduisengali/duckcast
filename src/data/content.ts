...
export const episodes: Episode[] = [
  ...
  },
  {
    ...
    thumbnailUrl: "/previews/ep-31.jpg",
  ...
  },
  {
    ...
    thumbnailUrl: "/previews/ep-30.jpg",
  ...
  },
  {
    ...
    thumbnailUrl: "/previews/ep-29.jpg",
  ...
  },
  {
    ...
    thumbnailUrl: "/previews/ep-28.jpg",
...
export const guests: Guest[] = [
  { id: "g1", name: "Асылбек Исахов", achievement: "Президент Казахско-Американского университета", photoUrl: "/guests/asylbek.jpg", episodeUrl: "https://youtu.be/gbsmYJXOanY?si=3bm4b0RezP1fc9U2" },
  { id: "g2", name: "Евгений Солоницын", achievement: "Учитель математики из Forbes Kazakhstan 30 under 30", photoUrl: "/guests/evgeniy.jpg", episodeUrl: "https://youtu.be/0kwgs6tlkCk?si=IrMEQQcu6BHnzy7a" },
  { id: "g3", name: "Юркевич Мирон", achievement: "Четырехкратный серебряный призер IMO", photoUrl: "/guests/miron.jpg", episodeUrl: "https://youtu.be/SD0AeJ4xUl0?si=wsZeLxo3O0Tg0SRa" },
  { id: "g4", name: "Алмаз Кунгожин", achievement: "Заместитель председателя НАО «Республиканская физико-математическая школа»", photoUrl: "/guests/almas.jpg", episodeUrl: "https://youtu.be/M8DzbWQOKuY?si=fkPbrLFXqP1FApbb" },
  { id: "g5", name: "Галымжан Жылгелдиев", achievement: "Тренер олимпийского чемпиона - Елдоса Сметова", photoUrl: "/guests/galymzhan.jpg", episodeUrl: "https://youtu.be/rxjfXUY7QxI?si=Sr1TMvnJSBBnOhHM" },
  { id: "g6", name: "Өтеу Қуаныш", achievement: "Организатор олимпиад по ИИ", photoUrl: "/guests/kuanysh.jpg", episodeUrl: "https://youtu.be/Ina6lsPFRsg?si=LPQ8kL4ZPYl5ui9G" },
  { id: "g7", name: "Алихан Серикулы", achievement: "Поступил в Brown University", photoUrl: "/guests/alikhan.jpg", episodeUrl: "https://youtu.be/v2UEbAi_wPE?si=CnCa2hxwxykSWEQ_" },
  { id: "g8", name: "Которова Вера", achievement: "Олимпиадница по математике, победитель Texhnovation", photoUrl: "/guests/vera.jpg", episodeUrl: "https://youtu.be/wyHfq8CDBmk?si=QqjrETXzYPjN2f6y" },
];
